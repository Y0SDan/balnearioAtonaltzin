...
function enviarCorreo(body: any) { 
    ...
    var message = {
        ...
        subject: "Testing!",
        attachment: [
            {data: `<p>Para reestablecer tu contraseña, por favor haz clic en el siguiente enlace:</p><a href="http://localhost:4200/home/restablecer/${token}"> Click Aquí<a/>`, alternative: true }
        ]
    };

...
class ReservacionesController {
    ...
    addReserva(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            `, [ID_reservacion]);
                ...
                const respReservacion = yield database_1.default.query("INSERT INTO cobros (IdReservacion, MontoCobrado, Estado) VALUES (?, ?, 'Sin pagar')", [ID_reservacion, montoTotal]);
    ...
    mostrarReservasXUsuario(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;

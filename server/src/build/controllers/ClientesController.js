...
class ClientesController {
    ...
    obtenerClienteCorreo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query(`SELECT * FROM cliente WHERE Email = '${correo}'`);
            if (resp.length > 0)
                res.json(resp);
            else
    ...
    actualizarContrasena(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query("UPDATE cliente set password1 = ? WHERE Email = ?", [req.body.contrasena, decoded]);
            res.json(resp);
        });
    }
}
